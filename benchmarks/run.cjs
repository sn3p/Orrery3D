...
async function main() {
  ...
  try {
    ...
    const report = {
      ...
      harnessSha256: Object.fromEntries(["browser.js", "run.cjs", "server.cjs", "index.html", "../package-lock.json", "../src/js/Asteroids.js", "../src/js/prepareCatalogue.js", "../src/js/constants.js", "../src/js/Orrery3D.js", "../src/js/PlaybackClock.js", "../src/js/Gui/index.js", "../src/js/Gui/Stats.js"].map(file => [file,
